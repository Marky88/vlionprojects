 ...
 *
 */
object confusion_matrix2 {
    def main(args: Array[String]): Unit = {
//        //        val originFilePath = args(0)
//        //        val predictFilePath: String = args(1)
//        // 真实的0,1
//        val originFilePath = "E:\\gitdir\\learn_projects\\python_projects\\algorithm2\\data\\deepfm_product\\etl\\test.label"
//
//        // 预测的概率值
//        val predictFilePath = "E:\\gitdir\\learn_projects\\python_projects\\algorithm2\\data\\deepfm_product\\predict\\test_res.txt"
//
...
//            // val d = line.split(" ")(1)
//            val bigDecimal = BigDecimal(line)
//            //前面一个0.5的准确率,后面一个0.4当成1的准确率
//            if(bigDecimal >= 0.5) "1" else "0"
//        })
//
